...
export function FollowList({ type }: FollowListProps) {
  const followersParams = followersRouteApi.useParams();
  const followingParams = followingRouteApi.useParams();
  const { username } = type === "followers" ? followersParams : followingParams;
